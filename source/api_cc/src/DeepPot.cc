...
void DeepPot::compute(ENERGYTYPE& dener,
  ...
  std::vector<ENERGYTYPE> dener_;
  std::vector<VALUETYPE> datom_energy_, datom_virial_;
  dp->computew(dener_, dforce_, dforce_mag_, dvirial, datom_energy_, datom_virial_, dcoord_, dspin_,
               datype_, dbox, fparam_, aparam_);
  dener = dener_[0];
}
...
void DeepPot::compute(std::vector<ENERGYTYPE>& dener,
                      ...
                      const std::vector<VALUETYPE>& aparam_) {
  std::vector<VALUETYPE> datom_energy_, datom_virial_;
  dp->computew(dener, dforce_, dforce_mag_, dvirial, datom_energy_, datom_virial_, dcoord_, dspin_,
               datype_, dbox, fparam_, aparam_);
}
...
void DeepPot::compute(ENERGYTYPE& dener,
                      ...
                      const std::vector<VALUETYPE>& fparam_,
                      const std::vector<VALUETYPE>& aparam_) {
  std::cout << "box0: " << dbox << std::endl;
  std::cout << "atype0: " << datype_ << std::endl;
  std::vector<ENERGYTYPE> dener_;
  dp->computew(dener_, dforce_, dforce_mag_, dvirial, datom_energy_, datom_virial_, dcoord_, dspin_,
               datype_, dbox, fparam_, aparam_);
  dener = dener_[0];
...
void DeepPot::compute(std::vector<ENERGYTYPE>& dener,
                      ...
                      const std::vector<VALUETYPE>& fparam_,
                      const std::vector<VALUETYPE>& aparam_) {
  std::cout << "box1: " << dbox << std::endl;
  std::cout << "atype1: " << datype_ << std::endl;
  dp->computew(dener, dforce_, dforce_mag_, dvirial, datom_energy_, datom_virial_, dcoord_, dspin_,
               datype_, dbox, fparam_, aparam_);
}
