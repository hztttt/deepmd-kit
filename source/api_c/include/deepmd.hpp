...
inline void _DP_DeepPotComputeNListSP<double>(DP_DeepPot *dp,
                                            ...
                                            double *atomic_energy,
                                            double *atomic_virial) {
  DP_DeepPotComputeNList2SP(dp, nframes, natom, coord, spin, atype, cell, nghost, nlist,
                          ago, fparam, aparam, energy, force, force_mag, virial,
                          atomic_energy, atomic_virial);
}
...
inline void _DP_DeepPotComputeNListSP<float>(DP_DeepPot *dp,
                                           ...
                                           float *atomic_energy,
                                           float *atomic_virial) {
  DP_DeepPotComputeNListf2SP(dp, nframes, natom, coord, spin, atype, cell, nghost,
                           nlist, ago, fparam, aparam, energy, force, force_mag, virial,
                           atomic_energy, atomic_virial);
}
...
inline void _DP_DeepPotModelDeviComputeNListSP<double>(DP_DeepPotModelDevi *dp,
                                                     ...
                                                     double *atomic_energy,
                                                     double *atomic_virial) {
  DP_DeepPotModelDeviComputeNList2SP(dp, 1, natom, coord, spin, atype, cell, nghost,
...
inline void _DP_DeepPotModelDeviComputeNListSP<float>(DP_DeepPotModelDevi *dp,
                                                    ...
                                                    float *atomic_energy,
                                                    float *atomic_virial) {
  DP_DeepPotModelDeviComputeNListf2SP(dp, 1, natom, coord, spin, atype, cell, nghost,
                                    nlist, ago, fparam, aparam, energy, force, force_mag,
                                    virial, atomic_energy, atomic_virial);
}
 ...
 public:
  ...
  void compute(
    ...
    _DP_DeepPotComputeNListSP<VALUETYPE>(
        dp, nframes, natoms, coord_, spin_, atype_, box_, nghost, lmp_list.nl, ago,
        fparam__, aparam__, ener_, force_, force_mag_, virial_, nullptr, nullptr);
    DP_CHECK_OK(DP_DeepPotCheckOK, dp);
  };
  /**
   * @brief Evaluate the energy, force, virial, atomic energy, and atomic virial
  ...
  void compute(
    ...
    _DP_DeepPotComputeNListSP<VALUETYPE>(dp, nframes, natoms, coord_, spin_, atype_,
                                       box_, nghost, lmp_list.nl, ago, fparam__,
                                       aparam__, ener_, force_, force_mag_, virial_,
                                       atomic_ener_, atomic_virial_);
    DP_CHECK_OK(DP_DeepPotCheckOK, dp);
  };
  /**
 ...
 public:
  ...
  void compute(
    ...
    _DP_DeepPotModelDeviComputeNListSP<VALUETYPE>(
        dp, natoms, coord_, spin_, atype_, box_, nghost, lmp_list.nl, ago, fparam__,
        aparam__, ener_, force_, force_mag_, virial_, nullptr, nullptr);
    DP_CHECK_OK(DP_DeepPotModelDeviCheckOK, dp);
  ...
  void compute(
    ...
    _DP_DeepPotModelDeviComputeNListSP<VALUETYPE>(
        dp, natoms, coord_, spin_, atype_, box_, nghost, lmp_list.nl, ago, fparam__,
        aparam__, ener_, force_, force_mag_, virial_, atomic_ener_, atomic_virial_);
    DP_CHECK_OK(DP_DeepPotModelDeviCheckOK, dp);
